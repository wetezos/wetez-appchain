...
import (
	...
	appConsumer "github.com/wetezos/wetez-appchain/app"
...
// NewCoordinator initializes Coordinator with interchain security dummy provider and wetez consumer chain
